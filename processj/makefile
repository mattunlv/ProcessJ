...
TARGET_TEST_INCLUDES:=$(TARGET_RUNTIME_INCLUDES) $(RUNTIME_TESTS_INCLUDE_PATH) $(SYSTEM_INCLUDE_PATH) $(TEST_INCLUDE_PATH)

# -------
# Sources

TARGET_RUNTIME_SOURCES:=$(UTILITIES_SOURCE_PATH)$(ALLCPPCONST) $(RUNTIME_SOURCE_PATH)$(ALLCPPCONST) $(SYSTEM_SOURCE_PATH)$(ALLCPPCONST)
TARGET_TEST_SOURCES:=$(TARGET_RUNTIME_SOURCES) $(RUNTIME_TESTS_SOURCE_PATH)$(ALLCPPCONST) $(TEST_SOURCE_PATH)$(ALLCPPCONST)
