...
public class Guard extends AST {
    ...
    public final Expression getExpression() {
        ...
        return (this.statement instanceof ExprStat) ? ((ExprStat) this.statement).getExpression() : null;

    }

    public final Assignment getInputExpression() {

        final Expression expression = (this.statement instanceof ExprStat)
                ? ((ExprStat) this.statement).getExpression() : null;

        return (expression instanceof Assignment) ? (Assignment) expression : null;
