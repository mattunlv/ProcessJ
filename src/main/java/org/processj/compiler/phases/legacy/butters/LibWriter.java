package org.processj.compiler.phases.legacy.butters;
...
public class LibWriter {
    ...
    final String STG_NATIVELIB = "resources/stringtemplates/org.processj.butters/nativelib.stg";
    
    // Collection of templates
    STGroup stGroup;
    
    // This instance holds information with respect to the
    // native ProcessJ org.processj.library
    LibInfo lib;
