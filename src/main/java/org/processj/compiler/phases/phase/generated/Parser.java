...
import org.processj.compiler.ast.statement.alt.*;
...
import org.processj.compiler.ast.statement.switched.*;
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		BlockStatement b = (BlockStatement)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new ProcedureTypeDeclaration(m, t, new Name(id), f, i, a, b)    ;
		...
		int bright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		BlockStatement b = (BlockStatement)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new ProcedureTypeDeclaration(m, new PrimitiveType(t, PrimitiveType.VoidKind),
                                                        new Name(id), f, i, a, b)                       ;
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("procedure_type_declaration",5, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-8)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
