...
public class ProcessJParser extends Parser {
	...
	public static final int
		...
		RULE_modifiers = 4, RULE_pragma = 5, RULE_packageDeclaration = 6, RULE_importDeclaration = 7, 
		RULE_typeDeclaration = 8, RULE_procedureTypeDeclaration = 9, RULE_formalParameters = 10, 
		RULE_protocolTypeDeclaration = 11, RULE_protocolBody = 12, RULE_protocolCase = 13, 
		RULE_recordTypeDeclaration = 14, RULE_extends = 15, RULE_annotations = 16, 
		RULE_annotation = 17, RULE_annotation_value = 18, RULE_recordBody = 19, 
		RULE_recordMember = 20, RULE_type = 21, RULE_typeWithoutDims = 22, RULE_typeWithDims = 23, 
		RULE_primitiveType = 24, RULE_channelType = 25, RULE_channelEndType = 26, 
		RULE_modifier = 27, RULE_variableDeclaration = 28, RULE_variableDeclarators = 29, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"compilationUnit", "qualifiedName", "names", "name", "modifiers", "pragma", 
			"packageDeclaration", "importDeclaration", "typeDeclaration", "procedureTypeDeclaration", 
			...
			"primitiveType", "channelType", "channelEndType", "modifier", "variableDeclaration", 
	...
	public final ProcedureTypeDeclarationContext procedureTypeDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_procedureTypeDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ProtocolTypeDeclarationContext protocolTypeDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_protocolTypeDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ProtocolBodyContext protocolBody() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_protocolBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ProtocolCaseContext protocolCase() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_protocolCase);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RecordTypeDeclarationContext recordTypeDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_recordTypeDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Annotation_valueContext annotation_value() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_annotation_value);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RecordBodyContext recordBody() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_recordBody);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RecordMemberContext recordMember() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_recordMember);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(366);
	...
	public final TypeWithoutDimsContext typeWithoutDims() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_typeWithoutDims);
		try {
			setState(378);
			_errHandler.sync(this);
	...
	public final TypeWithDimsContext typeWithDims() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_typeWithDims);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ChannelEndTypeContext channelEndType() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_channelEndType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
