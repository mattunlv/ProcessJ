...
public class ErrorTable {
    ...
    private final static Object[] Index_806 = new Object[]
            { ReachabilityAssert.NotEnclosedInBreakableContext.class, Context.class, BreakStatement.class };

    private final static Object[] Index_807 = new Object[]
            { ReachabilityAssert.EnclosedInParallelContext.class, Context.class, ReturnStatement.class };
    ...
    private final static Object[] Index_812 = new Object[]
            { ReachabilityAssert.NotEnclosedInIterativeContext.class, Context.class, ContinueStatement.class };

    private final static Object[] Index_813 = new Object[]
            { SemanticAssert.ParallelContextEmpty.class, Context.class };
